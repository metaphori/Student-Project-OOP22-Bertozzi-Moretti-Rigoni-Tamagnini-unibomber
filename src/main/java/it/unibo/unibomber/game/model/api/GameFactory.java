...
public interface GameFactory {
    ...
    /**
     * @param keyCodesPlayerOne the key code which corresponds to the first player
     *                          inputs, see makeOnePlayerGame
     * @param keyCodesPlayerTwo the key code which corresponds to the second player
     *                          inputs, see makeOnePlayerGame
     * @return an instance of a Game where only one player controlls a character
     */
